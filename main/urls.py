...
urlpatterns = [
    ...
    path('api.getingredients', views.getIngredients, name='getIngredients'),
    path('api.addnewingredient', views.addNewIngredients, name='addNewIngredients'),
    path('api.useringredients', views.actionUserIngredients, name= 'actionUserIngredients'),
